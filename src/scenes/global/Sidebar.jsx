...
import  TimelineOutlinedOutlinedIcon  from "@mui/icons-material/TimelineOutlined";
    ...
    <Box sx={{ 
      ...
      <ProSidebar collapsed={isCollapsed}>
        <Menu iconShape="square">
            {/* LOGO AND MENU ICON */}
            <MenuItem
              onClick={()=> {console.log(isCollapsed); setIsCollapsed(!isCollapsed); console.log(isCollapsed)}}
              ...
              <Box mb="20px">
                <Box display="flex" justifyContent="center" alignItems="center">
                  <img 
                    ...
                    style={{ cursor: "pointer", borderRadius:"50%", backgroundColor:"#e0e0e0"}}
            ...
            <Box paddingLeft={isCollapsed ? undefined : "10%"}>
                ...
                <Item
                  title="Line Chart"
                  to="/line"
                  icon={<TimelineOutlinedOutlinedIcon/>}
                  selected={selected}
                  setSelected={setSelected}
                />
                <Item
